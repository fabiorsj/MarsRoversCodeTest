...
namespace MarsRovers.Tests
{
    ...
    public class TestInputs
    {
        ...
        public void TestInput()
        {
            ...
            rover.InitialPosition = new Position() { X = X, Y = Y, Heading = Heading };
            ...
            Assert.Equal("1 3 N", $"{result.CurrentPosition.X} {result.CurrentPosition.Y} {result.CurrentPosition.Heading}");
        }
    }
}
